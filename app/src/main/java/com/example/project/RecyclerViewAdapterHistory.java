...
public class RecyclerViewAdapterHistory extends RecyclerView.Adapter<RecyclerViewAdapterHistory.HistoryViewHolder>{
    ...
    private ArrayList<com.example.project.History> histories;
    private Context context;

    public RecyclerViewAdapterHistory(Context context, ArrayList<com.example.project.History> histories) {
        ...
        public HistoryViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, com.example.project.WordMeaningActivity.class);
