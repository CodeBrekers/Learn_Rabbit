...
public class LoadDatabaseAsync extends AsyncTask<Void, Void, Boolean> {
    ...
    private com.example.project.DatabaseHelper myDbHelper;
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        myDbHelper = new com.example.project.DatabaseHelper(context);
    ...
    protected void onPostExecute(Boolean result) {
        ...
        alertDialog.dismiss();
        com.example.project.Dictionary.openDatabase();
    }
}
